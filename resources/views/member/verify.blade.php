...
<head>
        ...
        <meta content="Computer Society of Zimbabwe - Student Membership Registration" name="description" />
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active fade-in" id="account">
                            <div class="membership-info">
                                <h5><i class="mdi mdi-school"></i> Student Membership Information</h5>
                                <p>Join the Computer Society of Zimbabwe as a student member and kickstart your IT career journey!</p>
                                ...
                                <div class="info-grid">
                                    <div class="info-card">
                                        ...
                                        <ul>
                                            ...
                                            <li>Pursuing an IT-related course or program</li>
                                    ...
                                    <div class="info-card">
                                        ...
                                        <ul>
                                            <li>Access to networking events and conferences</li>
                                    ...
                                    <div class="info-card">
                                        ...
                                        <ul>
                                            <li>Annual membership fee: $50</li>
                        ...
                        <div class="tab-pane fade slide-in" id="profile">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="current_school" required>
                                    <div class="invalid-feedback">Please enter your current school</div>
                                          </div>

                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Current Educational Year</label>
                                    <select class="form-select" name="current_year" required>
                                    ...
                                    <div class="invalid-feedback">Please select your current educational year</div>
                                                          </div>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" name="amount" value="2" readonly>
                                                        </div>
                                          </div>
