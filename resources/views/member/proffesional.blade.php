...
<head>
        <meta charset="utf-8" />
        <title>CSZ Membership | Professional Membership</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Computer Society of Zimbabwe - Professional Membership Registration" name="description" />
...
<body class="authentication-bg">
    <div class="registration-container">
        <div class="card">
            <div class="card-header text-center">
                ...
                <h4 class="mb-0">Professional Membership Registration</h4>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active fade-in" id="account">
                            <div class="membership-info">
                                <h5><i class="mdi mdi-briefcase"></i> Professional Membership Information</h5>
                                <p>Join CSZ as a Professional Member and enhance your career in the IT industry!</p>

                                <div class="info-grid">
                                    <div class="info-card">
                                        <h6><i class="mdi mdi-account-check"></i>Eligibility</h6>
                                        <ul>
                                            <li>Working IT professional</li>
                                            <li>Minimum 2 years industry experience</li>
                                            <li>Relevant qualifications or certifications</li>
                                            <li>Active involvement in IT sector</li>
                                            <li>Professional references required</li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="info-card">
                                        ...
                                        <ul>
                                            ...
                                            <li>Advanced professional development</li>
                                            <li>Exclusive industry events access</li>
                                            <li>Voting rights in CSZ matters</li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="info-card">
                                        ...
                                        <ul>
                                            <li>Annual membership fee: $250</li>
                                            <li>Valid for one year from registration</li>
                                            <li>Professional development requirements</li>
                                            <li>Adherence to CSZ Code of Ethics</li>
                                            <li>Opportunity to join special committees</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label class="form-label">Which of the following Special Interest Groups, Focus Groups and seminars would you be interested in joining/attending?</label>
                        ...
                        <div class="tab-pane fade slide-in" id="profile">
                            <div class="row">
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <small class="text-danger d-block mb-2">* At least one professional experience entry is required</small>
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-bordered" id="professional-experience-table">
                                                    <thead class="table-light">
                                                        <tr>
                                                            <th>Company name and address</th>
                                                            <th>Role title & brief description of key responsibilities</th>
                                                            <th colspan="2" class="text-center">Duration</th>
                                                            <th class="text-danger">Official Use</th>
                                                        </tr>
                                                        <tr>
                                                            <th></th>
                                                            <th></th>
                                                    ...
                                                    <tbody>
                                                        <tr class="experience-row">
                                                            ...
                                                            <td><textarea class="form-control" name="role_description[]" rows="2" required></textarea></td>
                                                            <td><input type="month" class="form-control" name="from_date[]" required></td>
                                                            <td><input type="month" class="form-control" name="to_date[]" required></td>
                                                            <td>
                                            ...
                                            <button type="button" class="btn btn-outline-primary btn-sm mt-2" id="add-experience">
                                                <i class="mdi mdi-plus"></i> Add More Experience
                                            </button>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Professional Experience - Add More Functionality
            const addExperienceBtn = document.getElementById('add-experience');
            if (addExperienceBtn) {
                addExperienceBtn.addEventListener('click', function() {
                    const table = document.getElementById('professional-experience-table');
                    ...
                    newRow.innerHTML = `
                        ...
                        <td><textarea class="form-control" name="role_description[]" rows="2"></textarea></td>
                        <td><input type="month" class="form-control" name="from_date[]"></td>
                        <td><input type="month" class="form-control" name="to_date[]"></td>
                        <td>
                            <button type="button" class="btn btn-outline-danger btn-sm remove-experience">
                                <i class="mdi mdi-delete"></i>
                            </button>
                    ...
                    const removeBtn = newRow.querySelector('.remove-experience');
                    removeBtn.addEventListener('click', function() {
                        if (tbody.querySelectorAll('tr').length > 1) {
                            tbody.removeChild(newRow);
                        } else {
                            alert('At least one professional experience entry is required.');
                        }
                    });
                });
            }

            // Add remove functionality to the first professional experience row
